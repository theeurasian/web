    ...
    switch (this.getLang()) {
      ...
      case 'id':{
        switch (input) {
          ...
          case 'LLC "CCC", 123007. Moscow, 2nd Horoshevsky prospect, 9, building 2, office 103': return 'LLC "CCC", 123007. Moskow, prospek Horoshevsky ke-2, 9, gedung 2, kantor 103';
      ...
      case 'kr':{
        switch (input) {
          ...
          case 'LLC "CCC", 123007. Moscow, 2nd Horoshevsky prospect, 9, building 2, office 103': return 'LLC "CCC", 123007. 모스크바, 두 번째 Horoshevsky 전망, 9, 건물 2, 사무실 103';
      ...
      case 'vn':{
        switch (input) {
          ...
          case 'LLC "CCC", 123007. Moscow, 2nd Horoshevsky prospect, 9, building 2, office 103': return 'LLC "CCC", 123007. Matxcova, khách hàng tiềm năng Horoshevsky thứ 2, 9, tòa nhà 2, văn phòng 103';
      ...
      case 'zh':{
        switch (input) {
          ...
          case 'LLC "CCC", 123007. Moscow, 2nd Horoshevsky prospect, 9, building 2, office 103': return 'LLC "CCC", 123007. 莫斯科, 2nd Horoshevsky 远景地, 9, 2 号楼, 办公室 103';
